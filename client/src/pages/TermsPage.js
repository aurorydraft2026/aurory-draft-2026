        ...
        <div className="legal-page">
            ...
            <main className="legal-content">
                <section>
                    ...
                    <p>By accessing or using <strong>Asgard</strong>, you agree to be bound by these Terms of Service. If you do not agree, please do not use the application. We reserve the right to modify these terms at any time, and your continued use constitutes acceptance of those changes.</p>
                </section>

                <section className="legal-section">
                    <h3>2. Tournament Participation</h3>
                    <p>Asgard facilitates match pools using <strong>AURY</strong> tokens. By depositing tokens to our designated wallet, you acknowledge that these funds are used for tournament entry and prize distribution.</p>
                </section>
                ...
                <section>
                    ...
                    <p>In no event shall Asgard be liable for any indirect, incidental, or consequential damages resulting from your use of the service, including loss of tokens due to user error or blockchain-related failures.</p>
                </section>
